...
public class OddsServiceImpl extends ServiceImpl<OddsMapper, Odds> implements OddsService {
    ...
    public void refreshOdds(String mid) {
        ...
        List<Odds> odds = Oko.oddsExtract(mid);
        ...
        List<OddChangePlatform> oddChangePlatforms = Oko.oddChangePlatformExtract(mid);
        for (OddChangePlatform oddChangePlatform : oddChangePlatforms) {
            List<OddsChangeDetail> oddsChangeDetails = Oko.oddsChangeDetailExtract(mid, oddChangePlatform);
